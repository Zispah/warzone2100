...
function checkForPowerModule()
{
	if (cheat || powerModuleBuilt())
	{
		...
		setMissionTime(camChangeOnDiff(camMinutesToSeconds(20))); // 20 min for offworld
		secondVideo();
...
function eventStartLevel()
{
	...
	setMissionTime(camChangeOnDiff(camMinutesToSeconds(8))); // 8 min for building module.
